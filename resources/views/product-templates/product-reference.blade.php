<div class="section bg-white g-0">
  <div class="row align-items-center d-none d-md-flex">
    <div class="col-md-10 text-left my-2">
      <span class="ms-3">You May Also Like</span>
    </div>
  ...
  <div class="row align-items-center d-flex mx-1 d-md-none border-bottom border-3 border-dark">
    <div class="col-12 text-left my-2 ">
      <span class="ms-3">You May Also Like</span>
    </div>
  </div>
  <div class="row align-items-center d-flex d-md-none">
    <div class="col-2 offset-10 owl-controls clickable">
      <div class="owl-buttons-mobile d-flex float-end">
        <div class="owl-prev customPrevBtn border-start p-3 h-100 rounded-0"><i class="fa fa-chevron-left"></i></div>
        <div class="owl-next customNextBtn border-start border-end p-3 h-100 rounded-0"><i class="fa fa-chevron-right"></i></div>
      </div>
    </div>
  </div>
  <div class="row">
